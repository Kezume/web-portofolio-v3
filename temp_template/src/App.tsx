...
export default function App() {
  ...
  const typingTitles = ["Software Engineer", "Backend Specialist", "Web Developer"];
  ...
  return (
    <div className={`min-h-screen ${isLightMode ? "bg-zinc-50 text-zinc-900 light-theme" : "grid-bg text-[#FAFAFA]"} font-sans transition-colors duration-200 relative`}>
      ...
      {/* NAVBAR */}
      <nav className={`sticky top-0 z-40 w-full px-6 h-16 flex items-center justify-between transition-colors duration-200 ${isLightMode ? "bg-zinc-50/80 backdrop-blur-md border-b border-zinc-200" : "glass bg-[#18181B]/70"}`}>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2 rounded-xl bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-zinc-200 cursor-pointer hidden sm:flex"
      ...
      {/* HERO SECTION */}
      <section id="hero" className="min-h-[calc(100vh-4rem)] flex items-center py-16 px-6 relative z-10">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl sm:text-6xl font-display font-extrabold tracking-tight text-white leading-tight">
              I build resilient <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-cyan-400 to-teal-500">
                {typedText}
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((proj: Project) => (
              <motion.div
                key={proj.id}
                whileHover={{ y: -4 }}
                className={`rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between cursor-pointer transition-all duration-200 ${isLightMode ? "bg-zinc-100 border border-zinc-200 text-zinc-900" : "glass"}`}
      ...
      {/* GITHUB INTEGRATION */}
      <GitHubSection isLightMode={isLightMode} />
      ...
      <footer className={`border-t py-12 px-6 ${isLightMode ? "border-zinc-200 bg-zinc-100" : "border-white/5 bg-[#09090B]/50"}`}>
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-zinc-500 font-mono">© 2026 Roihan. Port 3000 Node.</span>
          </div>
